...
class Exp_Short_Term_Forecast(Exp_Basic):
    ...
    def test(self, setting, test=0):
        ...
        # result save
        if self.args.use_monarch:
            folder_path = './m4_results/' + self.args.model + '_mo' + '/'
        else:
        ...
        if 'Weekly_forecast.csv' in os.listdir(file_path) \
            ...
            f.write("{}_mo{}\n".format(self.args.model, self.args.use_monarch))
            f.write('smape: {}'.format(smape_results))
            f.write('\n')
            f.write('mape: {}'.format(mape))
            f.write('\n')
            f.write('mase: {}'.format(mase))
            f.write('\n')
            f.write('owa: {}'.format(owa_results))
            f.write('\n')
            f.write('\n')
            f.close()
