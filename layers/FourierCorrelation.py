...
from layers.MonarchMatrix import MonarchAttention
...
class FourierBlock(nn.Module):
    ...
    def build_monarch(self, sqrt_n, d_model, n_head, use_monarch=False):
        ...
        if self.use_monarch:
            self.monarch_attention = MonarchAttention(False, sqrt_n, d_model, self.dropout)
    ...
    def forward(self, q, k, v, mask):
        ...
        if self.use_monarch:
            x, corr = self.monarch_attention(q, k, v)
